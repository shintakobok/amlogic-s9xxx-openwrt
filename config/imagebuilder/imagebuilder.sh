...
rebuild_firmware() {
    ...
    my_packages="\
        ...
        kmod-usb-net-rndis kmod-usb-net-cdc-ether openssh-sftp-server nano ntfs-3g \
        php8 php8-cgi php8-mod-session php8-mod-ctype php8-mod-fileinfo php8-mod-zip \
        iconv php8-mod-iconv php8-mod-mbstring php8-mod-gmp php8-mod-gettext php8-mod-pcntl php8-cli php8-mod-curl \
        \
